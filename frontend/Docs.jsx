      ...
      <div className="docs-container">
        ...
        <div className="docs-hero">
          ...
          <p className="docs-subtitle">
            Everything you need to build, deploy, and monetize with LockPay
          </p>
        </div>
        ...
        <div className="docs-content">
          ...
          <section id="introduction" className="docs-section">
            <h2>Introduction</h2>
            <p>
              LockPay is a decentralized paywall protocol that enables instant monetization of any web content through native cryptocurrency payments. Built on BNB Chain with MetaMask integration, LockPay brings the vision of HTTP 402 "Payment Required" to life in the Web3 era.
            </p>
            <div className="info-card">
              <div className="info-card-icon">💡</div>
              <div>
                <strong>What makes LockPay unique?</strong>
                <p>Unlike traditional paywalls that require accounts, subscriptions, and credit cards, LockPay enables instant, permissionless payments using native BNB on BNB Chain. No middlemen, no platform fees, no accounts needed.</p>
              </div>
            </div>
          </section>
          ...
          <section id="http-402" className="docs-section">
            ...
            <p>
              The HTTP 402 status code was reserved in 1997 for future use as "Payment Required" but remained largely unimplemented for decades. LockPay brings this protocol to life for the blockchain era.
            </p>
...
X-Payment-Memo: paywall-abc123`}</code></pre>
          ...
          <section id="how-it-works" className="docs-section">
            <h2>How It Works</h2>
            <p>LockPay uses a simple but powerful architecture:</p>
          ...
          <section id="features" className="docs-section">
            ...
            <div className="feature-list">
              ...
              <div className="feature-detail">
                ...
                <p>LockPay <strong>never</strong> holds your funds. Payments go directly from payer to your wallet address. You retain full custody and control of your earnings at all times.</p>
              </div>
...
const address = await signer.getAddress();`}</code></pre>
  ...
  "walletAddress": "0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb"
            ...
            <div className="code-block">
              ...
              <pre><code>{`{
  "paywall_id": "abc123",
  "paywall_link": "https://lockpay.io/paywall/abc123",
  "price": "0.01",
  "currency": "BNB",
  "status": "created",
  "walletAddress": "0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb",
          ...
          <section id="security" className="docs-section">
            ...
            <div className="security-grid">
              <div className="security-item">
                <h4>🔐 Non-Custodial</h4>
                <p>LockPay never holds or accesses your funds. All payments go directly to your wallet address.</p>
              </div>
          ...
          <section id="faq" className="docs-section">
            ...
            <div className="faq-list">
              <div className="faq-item">
                ...
                <p>LockPay charges <strong>0% platform fees</strong>. The only costs are BNB Chain gas fees (typically $0.001-$0.01 per transaction).</p>
              </div>
              
              <div className="faq-item">
                <h4>Do I need an account?</h4>
                <p>No. LockPay is completely permissionless. Just provide a wallet address and start earning.</p>
              </div>
              ...
              <div className="faq-item">
                ...
                <p>Yes! LockPay is live on BNB Chain mainnet and ready for production use.</p>
              </div>
